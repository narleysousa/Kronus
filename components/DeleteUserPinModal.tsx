...
export const DeleteUserPinModal: React.FC<DeleteUserPinModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 animate-in fade-in duration-200" role="dialog" aria-modal="true" aria-labelledby="delete-user-pin-title">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-in zoom-in-95 duration-200">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-full shrink-0 bg-rose-100 text-rose-600">
            <AlertTriangle size={24} aria-hidden />
          </div>
          <div className="flex-1 min-w-0">
            <h3 id="delete-user-pin-title" className="text-lg font-bold text-slate-800">Excluir usuário</h3>
        ...
        <div className="mt-6 space-y-4">
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2 text-center">Seu PIN (4 dígitos)</label>
          ...
          <div className="flex gap-3 justify-end pt-2">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={!isValid}
              className="px-4 py-2.5 rounded-xl font-semibold text-white bg-rose-500 hover:bg-rose-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
